        ...
        <div style={{marginBottom:"10px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"8px"}}>
            <div style={{display:"flex",gap:"6px"}}>
             ...
             {Object.keys(REGION_GROUPS).map(g=>{const isActive=activeGroup===g;return(<button key={g} onClick={()=>{setActiveGroup(activeGroup===g?"전체":g);setFRegion("전체");}} style={{padding:"5px 12px",borderRadius:"20px",fontSize:"12px",fontWeight:700,cursor:"pointer",fontFamily:"inherit",transition:"all .12s",border:isActive?`2px solid ${K.night}`:`1px solid #c0b8a8`,background:isActive?K.night:"#f0ece4",color:isActive?K.gold:K.muted}}>{g}</button>);})}
